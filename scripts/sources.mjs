// Where the preserved original arcade source lives: IN THIS REPO, at
// reference/original-source/<dirbase>/.
//
...
export const SOURCE_ROOT = join(ROOT, 'reference', 'original-source');
