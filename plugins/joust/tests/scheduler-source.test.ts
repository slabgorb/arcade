...
// loader jt8-3 extracted. Behaviour-preserving — the shared `claimCovers` is the
// same coverage rule tests/audit/citations.test.ts uses: a range like
// `SYSTEM.SRC:341-346` is covered by ONE claim whose line falls in it.
