...
//
// PORTED from star-wars/tests/core/math3d.camera-mvp.test.ts (bz1-1, epic bz1
// "port, don't share" ruling). Byte-for-byte the star-wars original below the
// star-wars header; only this Battlezone provenance note is new. RED until
// GREEN ports battlezone/src/core/math3d.ts (with `scaling` + `viewMatrix`).
//
