// tests/core/math3d.test.ts
//
// PORTED from star-wars/tests/core/math3d.test.ts — the Math Box spec.
// Per epic bz1's "port, don't share" ruling (bz1-1): Battlezone copies
// star-wars's math3d.ts AND its two test suites unchanged into src/core/ +
// tests/core/. The assertions below are byte-for-byte the star-wars original;
// only this provenance header is new. RED until GREEN adds
// battlezone/src/core/math3d.ts (Dev ports it verbatim with its own provenance
// header). Divergence later is evidence for a future shared-lib extraction
// story, not a defect.
