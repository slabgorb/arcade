...
// finishGround / PMREB; sw8-12 adds themeB / PMTHB, the space 10s milestone).
// Typed as TuneName[], this is a COMPILE-TIME assertion that the TUNES manifest
// declares a file for each (TuneName ⊆ keyof TUNES), and the pump's
// playTune(event.tune) type-checks against it.
const REQUIRED_TUNES: TuneName[] = [
  'deathKnell', 'cantina', 'finale', 'bensTheme', 'descent', 'finishGround', 'themeB',
]
