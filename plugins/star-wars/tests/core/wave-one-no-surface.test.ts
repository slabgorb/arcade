...
// ported ROM time-box — this suite's subject is WHERE space clears TO, not when.
import { SPACE_PHASE_OVER } from '../support/space-phase-end'

/** A space phase at a chosen wave, already at the phase's end, cleared of enemies
