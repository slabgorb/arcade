...
//
// Today `applyManeuver` (src/core/sim.ts:1873) applies AIM_PLAYER/AIM_AHEAD as
...
import { rotationX, rotationY, transform, dot, IDENTITY, type Vec3, type Mat4 } from '@shared/math3d'
