...
// guards checkClaims dispatches on (millipede accepts a TEXT {file,line,verbatim} OR
...
// A byte-shaped source ({file, offset, bytes}) — millipede's isValidClaimSource ORs
...
describe('loadClaims hardening (df1-6) — millipede', () => {
