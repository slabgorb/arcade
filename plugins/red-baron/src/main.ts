...
function draw(
  ...
  if (overheated) {
    // rb4-19: the ROM HUD glyph font — the warning strokes through @shared/font
  ...
  // the ROM HUD glyph font has arrived — the readout strokes through @shared/font
...
function frame(nowMs: number): void {
  ...
  if (gameOver && ctx) {
    // rb4-19: the end-state card strokes through @shared/font — the draw()
