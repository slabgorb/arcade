...
//
// Why not `@shared/audio`: that shared engine is a SAMPLE (.wav) buffer
...
// `@shared/synth`. Red Baron is the DONOR: that skeleton is this file's,
...
import { createSynthEngine, noiseBuffer, type SynthTarget, type Voice } from '@shared/synth'
