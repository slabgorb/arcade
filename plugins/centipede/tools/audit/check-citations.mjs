 ...
 * centipede carries no byte claims). Exported so loadClaims can gate its load
 * boundary with the SAME predicate checkClaims uses, keeping the two from drifting
 * (df1-6).
 */
