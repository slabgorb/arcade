...
// guards checkClaims dispatches on (centipede accepts a TEXT {file,line,verbatim}
// source ONLY — it carries no byte claims, so there is no byte/nibble case here).
//
...
describe('loadClaims hardening (df1-6) — centipede', () => {
