...
## Title
Shootable enemy fireballs (Wave 1) — destroy an incoming TIE fireball by hitting it with a player laser before it reaches the cockpit
...
---
_Generated by `pf context create story 8-18` from the sprint YAML._
