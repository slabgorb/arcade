...
## Title
TIE fighters fly at a fixed orientation — bank/rotate toward the player like the cabinet (Wave 1)
...
---
_Generated by `pf context create story 8-13` from the sprint YAML._
