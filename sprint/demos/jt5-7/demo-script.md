...
## Demo Script — Make the jt5 epic YAML truthful (epic opener, jt5-1, jt5-3) and fix joust's unguarded README counts

### Scene 1: Setup (30 sec)
**Presenter says:** "Today we're going to show you what we built for Make the jt5 epic YAML truthful (epic opener, jt5-1, jt5-3) and fix joust's unguarded README counts."
...
**Show:** jt5-3's STORY description cites the wing-down cue at JOUSTRV4.SRC:6216-6218 (GOFLAP :6212 -> FLAST2 :6216), never :6207-6218. The cited span is re-opened and shown to contain 'LDX PDECSN,U / LDX DSNWD,X / JSR VSND', so the citation corroborates the claim instead of manufacturing corroboration.
...
**Presenter says:** "That's Make the jt5 epic YAML truthful (epic opener, jt5-1, jt5-3) and fix joust's unguarded README counts — shipped and verified."
