...
const GAMES = ['tempest', 'star-wars', 'asteroids', 'battlezone', 'red-baron', 'centipede', 'joust', 'missile-command', 'pac-man'];
...
test('plugins/ holds exactly the nine games this file loops over', () => {
