...
const GAMES = ['tempest', 'star-wars', 'asteroids', 'battlezone', 'red-baron', 'centipede', 'joust', 'missile-command', 'pac-man', 'millipede', 'defender'];
...
test('plugins/ holds exactly the eleven games this file loops over', () => {
